...
export const CredentialsSearch = () => {
    const [params, setParams] = useCredentialsParams() as [Record<string, any>, (p: any) => void];
...
export const CredentialsList = () => {
    ...
    return(
        ...
        renderItem={(credential) => < CredentialItem 
        data={credential}/>}
 ...
 const credentialLogos: Record<CredentialType, string> = {
    ...
    [CredentialType.ANTROPIC]: "/logos/anthropic/svg",
